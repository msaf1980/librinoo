...
# define	RINOO_JOBQUEUE_TIME(tv)		((tv.tv_sec * RINOO_JOBQUEUE_NBSTEPS) + (tv.tv_usec / (RINOO_JOBQUEUE_STEPMS * 1000)))
# define	RINOO_JOBQUEUE_TIMETOINDEX(tv)	(RINOO_JOBQUEUE_TIME(tv) % RINOO_JOBQUEUE_HASHSIZE)
