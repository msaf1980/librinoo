/**
 * @file   rinoo_sched_delmode.c
 * @author Reginald LIPS <reginald.l@gmail.com> - Copyright 2011
 * @date   Sun Jan  3 16:06:23 2010
 *
 * @brief  Test file for rinoo_sched_delmode function.
 *
 *
 */
...
int		main()
{
  ...
  XTEST(rinoo_sched_socket(RINOO_SCHED_MODADD, &tcpsock->socket, EVENT_SCHED_OUT) == 0);
  XTEST(tcpsock->socket.poll_mode == (EVENT_SCHED_IN | EVENT_SCHED_OUT));
  XTEST(rinoo_sched_socket(RINOO_SCHED_MODDEL, &tcpsock->socket, EVENT_SCHED_OUT) == 0);
  XTEST(tcpsock->socket.poll_mode == EVENT_SCHED_IN);
  XTEST(rinoo_sched_socket(RINOO_SCHED_MODADD, &tcpsock->socket, EVENT_SCHED_OUT) == 0);
  XTEST(tcpsock->socket.poll_mode == (EVENT_SCHED_IN | EVENT_SCHED_OUT));
  XTEST(rinoo_sched_socket(RINOO_SCHED_MODDEL, &tcpsock->socket, EVENT_SCHED_IN) == 0);
